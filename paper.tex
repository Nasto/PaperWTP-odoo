...
\author{Jens~Wiemann, Stephan~D\"orfler, Otto-von-Guericke-Universit\"at~Magdeburg,\\ \{jens.wiemann,~stephan.doerfler\}@st.ovgu.de}
...
\section{Basics for simplification of the configuration process}
\input{chapters/background}

\section{Workflow based on an existing software product line}
\input{chapters/concept}

\section{Examplary scenario}
